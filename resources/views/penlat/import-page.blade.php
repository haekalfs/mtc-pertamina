...
<div class="d-sm-flex align-items-center zoom90 justify-content-between">
    <div>
        <h1 class="h3 mb-2 font-weight-bold text-secondary"><i class="fa fa-list-alt"></i> Penlat Importer</h1>
        <p class="mb-4">Import List Pelatihan.</a></p>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('penlat.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-11">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body" style="background-color: rgb(247, 247, 247);">
                    ...
                    <img src="{{ asset('uploads/example2.jpeg') }}" class="img-fluid" style="padding: 1rem;">
                </div>
            </div>
        </div>
    </div>
