    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card" style="min-height: 500px;">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="position: relative;">
                @mtd_acc(3)
                <a href="#" data-id="{{ $data->id }}" data-name="{{ $data->description }}" data-type="{{ $data->type }}" data-date="{{ $data->approval_date }}" data-filepath="{{ $data->filepath }}" class="position-absolute edit-monitoring-approval" style="top: 15px; right: 15px; z-index: 10;">
            ...
            <div class="card-body d-flex justify-content-center align-items-center" style="min-height: 400px; height: 100%;">
                ...
                @elseif(!$isPdf)
                    <div class="alert alert-warning" role="alert">
                        The file is not in PDF format. Proceed to download the file by clicking download button. <a class="ml-2 btn btn-outline-secondary btn-sm" href="{{ asset($data->filepath) }}" download><i class="menu-Logo fa fa-download"></i></a>
                    </div>
                @else
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data" action="{{ route('monitoring-approval.update') }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small id="currentFile" class="d-inline-block text-secondary" style="cursor: pointer;"></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    @mtd_acc(4)
                    <a href="#" class="btn btn-danger text-white mr-2 delete-monitoring-approval" data-id="{{ $data->id }}"><i class="menu-Logo fa fa-trash-o"></i> Delete</a>
                    @endmtd_acc
