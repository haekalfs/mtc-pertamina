...
<div class="d-sm-flex align-items-center zoom90 justify-content-between">
    ...
    <div class="d-sm-flex"> <!-- Add this div to wrap the buttons -->
        <a href="{{ route('feedback-mtc') }}" class="btn btn-sm btn-secondary shadow-sm text-white"><i class="fa fa-backward"></i> Go Back</a>
    </div>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="text-right">
                        <a class="btn btn-primary btn-sm text-white" download href="{{ asset('uploads/template/template_mtc.xlsx') }}"><i class="menu-Logo fa fa-download"></i> Download Example</a>
                    </div>
                </div>
