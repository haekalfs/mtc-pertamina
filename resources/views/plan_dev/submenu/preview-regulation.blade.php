        ...
        <div class="card" style="min-height: 500px;">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="text-right">
                    @if($fileExists)
                        <a class="btn btn-primary btn-sm text-white mr-2" href="{{ asset($data->filepath) }}" download><i class="menu-Logo fa fa-download"></i> Download</a>
                    @endif
                    ...
                    <a href="#" class="btn btn-danger btn-sm text-white delete-regulation" data-id="{{ $data->id }}"><i class="menu-Logo fa fa-trash-o"></i> Delete</a>
                </div>
            </div>
