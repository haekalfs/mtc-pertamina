        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-secondary" id="judul">List Rooms</h6>
                                                    ...
                                                    @foreach($item->list as $index => $list)
                                                        ...
                                                        <tr>
                                                            <td style="width: 200px;" class="mb-2">
                                                                <i class="fa fa-chevron-right mr-2 chevron" style="cursor: pointer;" data-index="{{ $index }}"></i>
                                                                {{ $list->tools->asset_name }}
                                                                <div class="asset-stock mt-2" id="asset-stock-{{ $index }}" style="display: none;">
                                                                    Asset Stock: {{ $list->tools->asset_stock }} Unit(s)
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        @endif
...
<script>
    $(document).ready(function () {
        $('.chevron').on('click', function () {
            ...
            const $icon = $(this);
            const $stockDiv = $('#asset-stock-' + index);

            // Toggle the stock visibility
            $stockDiv.toggle();

            // Rotate the chevron
            if ($stockDiv.is(':visible')) {
