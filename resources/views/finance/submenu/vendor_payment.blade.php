            ...
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="text-right">
                        <a class="btn btn-primary btn-sm text-white" href="#" data-toggle="modal" data-target="#inputDataModal"><i class="menu-Logo fa fa-plus"></i> Register Payment</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a data-item-id="" class="btn btn-outline-secondary btn-sm mr-2 edit-btn"><i class="ti-eye"></i> Update Data</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Data 1</td>
