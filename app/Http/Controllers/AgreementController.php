...
class AgreementController extends Controller
{
    public function store(Request $request)
    {
        try {
            ...
            $agreement->company_name = $validatedData['company_name'];
            $agreement->company_details = $validatedData['company_details'];
            $agreement->status = $request->input('status');
            $agreement->date = $validatedData['agreement_date'];
            $agreement->user_id = auth()->id(); // Get authenticated user ID
            ...
            // Handle non-SPK details
            if ($request->filled('non_spk_details')) {
                $agreement->non_spk = $validatedData['non_spk_details'];
            }
            ...
            // Flash validation error messages to session
            Session::flash('error', implode('<br>', $e->validator->errors()->all()));
